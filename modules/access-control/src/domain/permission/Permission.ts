...
/**
 * A granular "resource:action" capability (e.g. `tenant:create`).
 *
 * Modeled as a Value Object because two permissions with the same name are
 * interchangeable — there is no lifecycle or identity of their own.
 */
